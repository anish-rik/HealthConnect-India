...
export type Dict = {
  ...
  a11y: {
    ...
    startScreenReading: string;
    stopScreenReading: string;
  };
};
...
export const translations: Record<LangCode, Dict> = {
  en: {
    ...
    hero: {
      ...
      subtitle:
        "HealthConnect links with your ABHA ID to show your medical history, prescriptions, and lab reports — in your language, simply.",
    ...
    how: {
      ...
      s2Text:
        "View your prescriptions, lab reports, and visit history from different hospitals in one place.",
      s3Title: "You Control the Sharing",
      s3Text:
        "Choose which doctor or hospital can view your records. Approve or revoke access anytime.",
    },
    features: {
      ...
      f2Text:
        "See visits, diagnoses, and medicines in a simple timeline instead of confusing records.",
      f3Title: "Consent You Understand",
      f3Text:
        "Clear consent cards show who can see your records, what they can access, and for how long.",
      f4Title: "Made for India's Languages",
      f4Text:
        "Switch between English, Kannada, Bengali, Hindi, Tamil, Telugu, and Malayalam with one tap.",
    },
    trust: {
    ...
    personas: {
      ...
      p1Name: "Ramesh Uncle, 68",
      p1Loc: "Nagpur",
      p1Quote:
        "I always forgot which medicines the doctor gave me last time. Now I just show my phone.",
      p2Name: "Priya, 26",
      p2Loc: "Chennai",
      p2Quote:
        "My lab reports were always on paper. Now I can share them with any doctor in seconds.",
      p3Name: "Suresh, 41",
      p3Loc: "Uttar Pradesh",
    ...
    a11y: {
      ...
      startScreenReading: "Start screen reading",
      stopScreenReading: "Stop screen reading",
    },
  },
  hi: {
    nav: {
    ...
    hero: {
      ...
      subtitle:
        "HealthConnect आपकी ABHA ID से जुड़कर आपका मेडिकल इतिहास, पर्चे और लैब रिपोर्ट आपकी भाषा में, सरलता से दिखाता है।",
    ...
    how: {
      ...
      s3Text:
        "चुनें कि कौन सा डॉक्टर या अस्पताल आपके रिकॉर्ड देख सकता है। पहुँच कभी भी दें या रद्द करें।",
    },
    features: {
      ...
      f3Text:
        "स्पष्ट सहमति कार्ड दिखाते हैं कि कौन आपके रिकॉर्ड देख सकता है, क्या देख सकता है, और कब तक।",
    ...
    personas: {
      ...
      p1Loc: "नागपुर",
      p1Quote:
        "मैं हमेशा भूल जाता था कि पिछली बार डॉक्टर ने कौन सी दवाइयाँ दी थीं। अब बस फोन दिखा देता हूँ।",
      p2Name: "प्रिया, 26",
      p2Loc: "चेन्नई",
      p2Quote:
        "मेरी लैब रिपोर्ट हमेशा कागज़ पर रहती थीं। अब मैं उन्हें किसी भी डॉक्टर के साथ सेकंडों में साझा कर सकती हूँ।",
      p3Name: "सुरेश, 41",
      p3Loc: "उत्तर प्रदेश",
    ...
    a11y: {
      ...
      startScreenReading: "स्क्रीन रीडिंग शुरू करें",
      stopScreenReading: "स्क्रीन रीडिंग बंद करें",
    },
  },
  kn: {
    nav: {
    ...
    hero: {
      ...
      subtitle:
        "HealthConnect ನಿಮ್ಮ ABHA ID ಗೆ ಸಂಪರ್ಕಿಸಿ ನಿಮ್ಮ ವೈದ್ಯಕೀಯ ಇತಿಹಾಸ, ಔಷಧಿ ಚೀಟಿಗಳು ಮತ್ತು ಲ್ಯಾಬ್ ವರದಿಗಳನ್ನು ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ ಸರಳವಾಗಿ ತೋರಿಸುತ್ತದೆ.",
    ...
    how: {
      ...
      s1Text:
        "ನಿಮ್ಮ 14-ಅಂಕಿಯ ABHA ಸಂಖ್ಯೆ ಅಥವಾ QR ಕೋಡ್ ಸ್ಕ್ಯಾನ್ ಮಾಡಿ ನಿಮ್ಮ ಆರೋಗ್ಯ ಖಾತೆಯನ್ನು ಸಂಪರ್ಕಿಸಿ.",
      s2Title: "ಎಲ್ಲಾ ದಾಖಲೆಗಳನ್ನು ನೋಡಿ",
      s2Text:
        "ವಿವಿಧ ಆಸ್ಪತ್ರೆಗಳ ಔಷಧಿ ಚೀಟಿಗಳು, ಲ್ಯಾಬ್ ವರದಿಗಳು ಮತ್ತು ಭೇಟಿಯ ಇತಿಹಾಸವನ್ನು ಒಂದೇ ಸ್ಥಳದಲ್ಲಿ ನೋಡಿ.",
      s3Title: "ಹಂಚಿಕೆ ನೀವೇ ನಿಯಂತ್ರಿಸಿ",
      s3Text:
        "ಯಾವ ವೈದ್ಯ ಅಥವಾ ಆಸ್ಪತ್ರೆ ನಿಮ್ಮ ದಾಖಲೆಗಳನ್ನು ನೋಡಬಹುದು ಎಂದು ಆಯ್ಕೆಮಾಡಿ. ಯಾವಾಗ ಬೇಕಾದರೂ ಪ್ರವೇಶ ನೀಡಿ ಅಥವಾ ರದ್ದುಗೊಳಿಸಿ.",
    },
    features: {
      heading: "ಸ್ಪಷ್ಟತೆಗೆ ಅರ್ಹರಾದ ರೋಗಿಗಳಿಗಾಗಿ ನಿರ್ಮಿಸಲಾಗಿದೆ",
      f1Title: "ನಿಮ್ಮ ಭಾಷೆಯಲ್ಲಿ ಓದಿ",
      f1Text:
        "ನೀವು ಚೆನ್ನಾಗಿ ತಿಳಿದಿರುವ ಭಾಷೆಯಲ್ಲಿ ವೈದ್ಯಕೀಯ ಮಾಹಿತಿಯನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವುದು ಸುಲಭವಾಗುತ್ತದೆ.",
      ...
      f3Text:
        "ಯಾರು ನಿಮ್ಮ ದಾಖಲೆಗಳನ್ನು ನೋಡಬಹುದು, ಏನು ನೋಡಬಹುದು, ಎಷ್ಟು ಸಮಯ ಎಂಬುದನ್ನು ಸ್ಪಷ್ಟ ಒಪ್ಪಿಗೆ ಕಾರ್ಡ್‌ಗಳು ತೋರಿಸುತ್ತವೆ.",
      f4Title: "ಭಾರತದ ಭಾಷೆಗಳಿಗಾಗಿ ನಿರ್ಮಿಸಲಾಗಿದೆ",
      f4Text:
        "ಒಂದೇ ಟ್ಯಾಪ್‌ನಲ್ಲಿ ಇಂಗ್ಲಿಷ್, ಕನ್ನಡ, ಬಂಗಾಳಿ, ಹಿಂದಿ, ತಮಿಳು, ತೆಲುಗು ಮತ್ತು ಮಲಯಾಳಂ ನಡುವೆ ಬದಲಿಸಿ.",
    },
    trust: {
    ...
    personas: {
      ...
      p1Name: "ರಮೇಶ್ ಅಂಕಲ್, 68",
      p1Loc: "ನಾಗಪುರ",
      p1Quote:
        "ಕಳೆದ ಬಾರಿ ವೈದ್ಯರು ಯಾವ ಔಷಧಿ ಕೊಟ್ಟಿದ್ದರು ಎಂದು ನಾನು ಯಾವಾಗಲೂ ಮರೆಯುತ್ತಿದ್ದೆ. ಈಗ ನಾನು ಫೋನ್ ತೋರಿಸುತ್ತೇನೆ.",
      p2Name: "ಪ್ರಿಯಾ, 26",
      p2Loc: "ಚೆನ್ನೈ",
      p2Quote:
        "ನನ್ನ ಲ್ಯಾಬ್ ವರದಿಗಳು ಯಾವಾಗಲೂ ಕಾಗದದ ಮೇಲೆ ಇದ್ದವು. ಈಗ ಯಾವುದೇ ವೈದ್ಯರಿಗೆ ಸೆಕೆಂಡುಗಳಲ್ಲಿ ಹಂಚಿಕೊಳ್ಳಬಹುದು.",
      p3Name: "ಸುರೇಶ್, 41",
      p3Loc: "ಉತ್ತರ ಪ್ರದೇಶ",
      p3Quote:
        "ಮೊದಲು ಕಾಗದಗಳು ಕಳೆದುಹೋಗುತ್ತಿದ್ದವು. ಈಗ ನನ್ನ ದಾಖಲೆಗಳನ್ನು ಹುಡುಕುವುದು ಮತ್ತು ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವುದು ಸುಲಭ.",
    },
    footer: {
    ...
    a11y: {
      ...
      startScreenReading: "ಪರದೆ ಓದುವುದನ್ನು ಪ್ರಾರಂಭಿಸಿ",
      stopScreenReading: "ಪರದೆ ಓದುವುದನ್ನು ನಿಲ್ಲಿಸಿ",
    },
  },
  bn: {
    nav: {
      ...
      help: "সহায়তা",
      cta: "ABHA ID যুক্ত করুন",
    },
    hero: {
      title: "আপনার স্বাস্থ্য রেকর্ড, অবশেষে আপনার হাতে।",
      subtitle:
        "HealthConnect আপনার ABHA ID-এর সাথে যুক্ত হয়ে আপনার চিকিৎসা ইতিহাস, প্রেসক্রিপশন এবং ল্যাব রিপোর্ট আপনার ভাষায় সহজে দেখায়।",
    ...
    how: {
      ...
      s1Text:
        "আপনার ১৪-সংখ্যার ABHA নম্বর ব্যবহার করুন বা QR কোড স্ক্যান করে আপনার স্বাস্থ্য অ্যাকাউন্ট সংযুক্ত করুন।",
      ...
      s3Text:
        "কোন ডাক্তার বা হাসপাতাল আপনার রেকর্ড দেখতে পারবে তা বেছে নিন। যেকোনো সময় অ্যাক্সেস দিন বা প্রত্যাহার করুন।",
    },
    features: {
      ...
      f2Text:
        "বিভ্রান্তিকর রেকর্ডের পরিবর্তে ভিজিট, রোগ নির্ণয় এবং ওষুধ একটি সহজ টাইমলাইনে দেখুন।",
      ...
      f4Text:
        "এক ট্যাপে ইংরেজি, কন্নড়, বাংলা, হিন্দি, তামিল, তেলুগু এবং মালয়ালমের মধ্যে পরিবর্তন করুন।",
    },
    trust: {
    ...
    personas: {
      ...
      p1Name: "রমেশ আঙ্কেল, ৬৮",
      p1Loc: "নাগপুর",
      p1Quote: "গতবার ডাক্তার কোন ওষুধ দিয়েছিলেন তা আমি সবসময় ভুলে যেতাম। এখন শুধু ফোন দেখাই।",
      p2Name: "প্রিয়া, ২৬",
      p2Loc: "চেন্নাই",
      p2Quote:
        "আমার ল্যাব রিপোর্ট সবসময় কাগজে থাকত। এখন যেকোনো ডাক্তারের সাথে সেকেন্ডে শেয়ার করতে পারি।",
      p3Name: "সুরেশ, ৪১",
      p3Loc: "উত্তর প্রদেশ",
    ...
    a11y: {
      ...
      startScreenReading: "স্ক্রিন রিডিং শুরু করুন",
      stopScreenReading: "স্ক্রিন রিডিং বন্ধ করুন",
    },
  },
  ta: {
    nav: {
      ...
      help: "உதவி",
      cta: "ABHA ID இணைக்கவும்",
    },
    hero: {
      title: "உங்கள் சுகாதார பதிவுகள், இறுதியாக உங்கள் கையில்.",
      subtitle:
        "HealthConnect உங்கள் ABHA ID உடன் இணைந்து உங்கள் மருத்துவ வரலாறு, மருந்துச்சீட்டுகள் மற்றும் ஆய்வக அறிக்கைகளை உங்கள் மொழியில் எளிமையாக காட்டுகிறது.",
    ...
    how: {
      ...
      s1Text:
        "உங்கள் 14-இலக்க ABHA எண் அல்லது QR குறியீட்டை ஸ்கேன் செய்து உங்கள் சுகாதார கணக்கை இணைக்கவும்.",
      s2Title: "அனைத்து பதிவுகளையும் பாருங்கள்",
      s2Text:
        "வெவ்வேறு மருத்துவமனைகளின் மருந்துச்சீட்டுகள், ஆய்வக அறிக்கைகள் மற்றும் வருகை வரலாற்றை ஒரே இடத்தில் பாருங்கள்.",
      s3Title: "பகிர்வை நீங்கள் கட்டுப்படுத்துங்கள்",
      s3Text:
        "எந்த மருத்துவர் அல்லது மருத்துவமனை உங்கள் பதிவுகளை பார்க்கலாம் என்பதை தேர்ந்தெடுக்கவும். எப்போது வேண்டுமானாலும் அணுகலை வழங்கலாம் அல்லது ரத்து செய்யலாம்.",
    },
    features: {
      ...
      f2Text:
        "குழப்பமான பதிவுகளுக்கு பதிலாக வருகைகள், நோயறிதல்கள் மற்றும் மருந்துகளை எளிய காலவரிசையில் பாருங்கள்.",
      f3Title: "நீங்கள் புரிந்துகொள்ளும் ஒப்புதல்",
      f3Text:
        "யார் உங்கள் பதிவுகளை பார்க்கலாம், என்ன பார்க்கலாம், எவ்வளவு காலம் என்பதை தெளிவான ஒப்புதல் அட்டைகள் காட்டுகின்றன.",
      f4Title: "இந்தியாவின் மொழிகளுக்காக உருவாக்கப்பட்டது",
      f4Text:
        "ஒரே தட்டலில் ஆங்கிலம், கன்னடம், வங்காளம், இந்தி, தமிழ், தெலுங்கு மற்றும் மலையாளம் இடையே மாறுங்கள்.",
    },
    trust: {
    ...
    personas: {
      ...
      p1Name: "ரமேஷ் மாமா, 68",
      p1Loc: "நாக்பூர்",
      p1Quote:
        "கடந்த முறை மருத்துவர் எந்த மருந்து கொடுத்தார் என்பதை எப்போதும் மறந்துவிடுவேன். இப்போது வெறும் தொலைபேசியை காட்டுகிறேன்.",
      p2Name: "பிரியா, 26",
      p2Loc: "சென்னை",
      p2Quote:
        "என் ஆய்வக அறிக்கைகள் எப்போதும் காகிதத்தில் இருந்தன. இப்போது எந்த மருத்துவருடனும் வினாடிகளில் பகிரலாம்.",
      p3Name: "சுரேஷ், 41",
      p3Loc: "உத்தர பிரதேசம்",
      p3Quote:
        "முன்பு காகிதங்கள் தொலைந்துபோகும். இப்போது என் பதிவுகளை கண்டுபிடிப்பதும் புரிந்துகொள்வதும் எளிது.",
    },
    footer: {
    ...
    a11y: {
      ...
      startScreenReading: "திரை வாசிப்பைத் தொடங்கு",
      stopScreenReading: "திரை வாசிப்பை நிறுத்து",
    },
  },
  te: {
    nav: {
      ...
      help: "సహాయం",
      cta: "ABHA ID లింక్ చేయండి",
    },
    hero: {
      title: "మీ ఆరోగ్య రికార్డులు, చివరికి మీ చేతిలో.",
      subtitle:
        "HealthConnect మీ ABHA IDతో అనుసంధానమై మీ వైద్య చరిత్ర, మందుల చీటీలు మరియు ల్యాబ్ నివేదికలను మీ భాషలో సరళంగా చూపుతుంది.",
    ...
    how: {
      ...
      s2Text:
        "వేర్వేరు ఆసుపత్రుల నుండి మీ మందుల చీటీలు, ల్యాబ్ నివేదికలు మరియు సందర్శన చరిత్రను ఒకే చోట చూడండి.",
      s3Title: "షేరింగ్ మీరే నియంత్రిస్తారు",
      s3Text:
        "ఏ వైద్యుడు లేదా ఆసుపత్రి మీ రికార్డులను చూడగలదో ఎంచుకోండి. ఎప్పుడైనా ప్రాప్యత ఇవ్వండి లేదా రద్దు చేయండి.",
    },
    features: {
      ...
      f2Text:
        "గందరగోళ రికార్డులకు బదులుగా సందర్శనలు, నిర్ధారణలు మరియు మందులను సరళమైన టైమ్‌లైన్‌లో చూడండి.",
      f3Title: "మీరు అర్థం చేసుకునే సమ్మతి",
      f3Text:
        "ఎవరు మీ రికార్డులను చూడగలరు, ఏమి చూడగలరు, ఎంతకాలం అనేది స్పష్టమైన సమ్మతి కార్డులు చూపుతాయి.",
      f4Title: "భారతదేశ భాషల కోసం రూపొందించబడింది",
      f4Text:
        "ఒక్క ట్యాప్‌తో ఇంగ్లీష్, కన్నడ, బెంగాలీ, హిందీ, తమిళం, తెలుగు మరియు మలయాళం మధ్య మారండి.",
    },
    trust: {
    ...
    personas: {
      ...
      p1Name: "రమేష్ అంకుల్, 68",
      p1Loc: "నాగపూర్",
      p1Quote:
        "గత సారి డాక్టర్ ఏ మందులు ఇచ్చారో నేను ఎల్లప్పుడూ మర్చిపోతాను. ఇప్పుడు ఫోన్ చూపిస్తాను.",
      p2Name: "ప్రియ, 26",
      p2Loc: "చెన్నై",
      p2Quote:
        "నా ల్యాబ్ నివేదికలు ఎల్లప్పుడూ కాగితంపై ఉండేవి. ఇప్పుడు ఏ వైద్యుడితోనైనా సెకన్లలో పంచుకోగలను.",
      p3Name: "సురేష్, 41",
      p3Loc: "ఉత్తర ప్రదేశ్",
      p3Quote:
        "ఇంతకు ముందు కాగితాలు పోతాయి. ఇప్పుడు నా రికార్డులు కనుగొనడం మరియు అర్థం చేసుకోవడం సులభం.",
    },
    footer: {
    ...
    a11y: {
      ...
      startScreenReading: "స్క్రీన్ రీడింగ్ ప్రారంభించండి",
      stopScreenReading: "స్క్రీన్ రీడింగ్ ఆపండి",
    },
  },
  ml: {
    nav: {
      ...
      help: "സഹായം",
      cta: "ABHA ID ലിങ്ക് ചെയ്യുക",
    },
    hero: {
      title: "നിങ്ങളുടെ ആരോഗ്യ രേഖകൾ, ഒടുവിൽ നിങ്ങളുടെ കൈകളിൽ.",
      subtitle:
        "HealthConnect നിങ്ങളുടെ ABHA IDയുമായി ബന്ധിപ്പിച്ച് നിങ്ങളുടെ ചികിത്സാ ചരിത്രം, കുറിപ്പടികൾ, ലാബ് റിപ്പോർട്ടുകൾ എന്നിവ നിങ്ങളുടെ ഭാഷയിൽ ലളിതമായി കാണിക്കുന്നു.",
    ...
    how: {
      ...
      s1Text:
        "നിങ്ങളുടെ 14-അക്ക ABHA നമ്പർ അല്ലെങ്കിൽ QR കോഡ് സ്കാൻ ചെയ്ത് ആരോഗ്യ അക്കൗണ്ട് ബന്ധിപ്പിക്കുക.",
      s2Title: "എല്ലാ രേഖകളും കാണുക",
      s2Text:
        "വ്യത്യസ്ത ആശുപത്രികളിലെ കുറിപ്പടികൾ, ലാബ് റിപ്പോർട്ടുകൾ, സന്ദർശന ചരിത്രം എന്നിവ ഒരിടത്ത് കാണുക.",
      s3Title: "പങ്കിടൽ നിങ്ങൾ നിയന്ത്രിക്കുന്നു",
      s3Text:
        "ഏത് ഡോക്ടർക്കോ ആശുപത്രിക്കോ നിങ്ങളുടെ രേഖകൾ കാണാൻ കഴിയണമെന്ന് തിരഞ്ഞെടുക്കുക. എപ്പോൾ വേണമെങ്കിലും അനുമതി നൽകാം അല്ലെങ്കിൽ പിൻവലിക്കാം.",
    },
    features: {
      heading: "വ്യക്തത അർഹിക്കുന്ന രോഗികൾക്കായി നിർമ്മിച്ചത്",
      f1Title: "നിങ്ങളുടെ ഭാഷയിൽ വായിക്കുക",
      f1Text:
        "നിങ്ങൾക്ക് നന്നായി അറിയാവുന്ന ഭാഷയിൽ ചികിത്സാ വിവരങ്ങൾ മനസ്സിലാക്കാൻ എളുപ്പമാകുന്നു.",
      f2Title: "കാലത്തിനൊപ്പം നിങ്ങളുടെ ആരോഗ്യം",
      f2Text:
        "ആശയക്കുഴപ്പമുള്ള രേഖകൾക്ക് പകരം സന്ദർശനങ്ങൾ, രോഗനിർണ്ണയങ്ങൾ, മരുന്നുകൾ ലളിതമായ ടൈംലൈനിൽ കാണുക.",
      f3Title: "നിങ്ങൾ മനസ്സിലാക്കുന്ന സമ്മതം",
      f3Text:
        "നിങ്ങളുടെ രേഖകൾ ആർക്ക് കാണാം, എന്ത് കാണാം, എത്രകാലം എന്ന് വ്യക്തമായ സമ്മത കാർഡുകൾ കാണിക്കുന്നു.",
      f4Title: "ഇന്ത്യയുടെ ഭാഷകൾക്കായി നിർമ്മിച്ചത്",
      f4Text:
        "ഒറ്റ ടാപ്പിൽ ഇംഗ്ലീഷ്, കന്നഡ, ബംഗാളി, ഹിന്ദി, തമിഴ്, തെലുങ്ക്, മലയാളം എന്നിവയ്ക്കിടയിൽ മാറുക.",
    },
    trust: {
    ...
    personas: {
      ...
      p1Name: "രമേശ് അങ്കിൾ, 68",
      p1Loc: "നാഗ്പൂർ",
      p1Quote:
        "കഴിഞ്ഞ തവണ ഡോക്ടർ ഏത് മരുന്നാണ് തന്നതെന്ന് ഞാൻ എപ്പോഴും മറന്നുപോകുമായിരുന്നു. ഇപ്പോൾ ഫോൺ കാണിക്കും.",
      p2Name: "പ്രിയ, 26",
      p2Loc: "ചെന്നൈ",
      p2Quote:
        "എന്റെ ലാബ് റിപ്പോർട്ടുകൾ എപ്പോഴും കടലാസിലായിരുന്നു. ഇപ്പോൾ ഏത് ഡോക്ടറുമായും സെക്കൻഡുകൾക്കുള്ളിൽ പങ്കിടാം.",
      p3Name: "സുരേഷ്, 41",
      p3Loc: "ഉത്തർപ്രദേശ്",
      p3Quote:
        "നേരത്തെ കടലാസുകൾ നഷ്ടപ്പെടുമായിരുന്നു. ഇപ്പോൾ എന്റെ രേഖകൾ കണ്ടെത്താനും മനസ്സിലാക്കാനും എളുപ്പമാണ്.",
    },
    footer: {
    ...
    a11y: {
      ...
      startScreenReading: "സ്ക്രീൻ റീഡിംഗ് ആരംഭിക്കുക",
      stopScreenReading: "സ്ക്രീൻ റീഡിംഗ് നിർത്തുക",
    },
  },
};
